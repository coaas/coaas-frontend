...
import { useTour, TourStep } from '../../../utils/useTour';
...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Here you can see all your namespaces (workspaces). Each namespace can contain multiple projects, team members, and resources. You can create new namespaces or manage existing ones.',
    target: 'main',
    position: 'top',
  },
];
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
          ...
          {/* Subtitle */}
          <p data-tour="subtitle" className="text-xl md:text-2xl text-gray-300 mb-4 max-w-3xl">
