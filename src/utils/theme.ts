...
export const themeClasses = {
  ...
  border: {
    ...
    secondary:
      'border-stroke-gray-dark dark:border-stroke-gray-dark border-gray-300',
  },
  ...
  card: {
    primary:
      'bg-area dark:bg-area bg-white border border-stroke-gray dark:border-stroke-gray border-gray-200 shadow-card dark:shadow-card shadow-card-light',
    secondary:
      'bg-area-dark dark:bg-area-dark bg-gray-50 border border-stroke-gray-dark dark:border-stroke-gray-dark border-gray-300',
  },
